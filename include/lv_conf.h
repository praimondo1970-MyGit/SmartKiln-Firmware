...
/* Fuentes Montserrat habilitadas (solo las usadas):
 * - LV_FONT_MONTSERRAT_14: iconos y textos pequeños
 * - LV_FONT_MONTSERRAT_16: nombre del horno
 * - LV_FONT_MONTSERRAT_18: textos de estado, valores
 * - LV_FONT_MONTSERRAT_44: temperatura grande
 * LV_FONT_MONTSERRAT_48 deshabilitada - no se usa
 */
...
#define LV_MEM_CUSTOM      0
    ...
    #define LV_MEM_SIZE    (128U * 1024U)          /*128 KB - Nivel original*/
